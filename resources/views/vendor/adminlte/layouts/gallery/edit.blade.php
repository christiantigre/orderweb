    ...
    <div class="col-md-8 col-md-offset-2">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">
            <!--titulo ventana-->Actualizar Item Galeria
          </h3>
            ...
            <section class="content">
              ...
              <div class="box">
                <div class="box-body">
                  ...
                  {!! Form::model($gallery,['route'=>['galleries.update', $gallery->id], 'files' => 'true', 'enctype'=>'multipart/form-data']) !!}

                  {{ csrf_field() }}
                  {{ method_field('PUT') }}

                  <div class="box-body">
                    @include('adminlte::layouts.gallery.form')
