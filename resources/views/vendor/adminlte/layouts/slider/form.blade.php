...
<div class="form-group">
	{!! Form::label('Titulo link','Titulo Link',['class'=>'col-sm-2 control-label']) !!}
	<div class="col-sm-10">
		{!! Form::text('tittle_link',null,['class'=>'form-control','autofocus'=>'autofocus','autocomplete'=>'off','placeholder'=>'Titulo Link ...']) !!}
