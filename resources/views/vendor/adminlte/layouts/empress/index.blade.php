    ...
    @foreach ($empress as $empres)
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          ...
          <h3 class="profile-username text-center">{{ $empres->name }}</h3>

          <p class="text-muted text-center">{{ $empres->slogan }}</p>

          <ul class="list-group list-group-unbordered">
            <li class="list-group-item">
              <b>Ruc</b> <a class="pull-right">{{ $empres->ruc }}</a>
            </li>
            <li class="list-group-item">
              <b>Email</b> <a class="pull-right">{{ $empres->email }}</a>
            </li>
            <li class="list-group-item">
              <b>Gerente</b> <a class="pull-right">{{ $empres->propietario }}</a>
            </li>
            <li class="list-group-item">
              <b>Telefono</b> <a class="pull-right">{{ $empres->telefono }}</a>
            </li>
            <li class="list-group-item">
              <b>Movil</b> <a class="pull-right">{{ $empres->cel1 }}-/-{{ $empres->cel2 }}</a>
            </li>
            <li class="list-group-item">
          ...
          <a href="edit/empress/{{bcrypt($empres->id)}}" class="btn btn-primary btn-block"><b>Editar</b></a>
        </div>
        <!-- /.box-body -->
      </div>
      <!-- /.box -->
