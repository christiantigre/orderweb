                    ...
                    <div class="post">
                      <div class="box-body">
                        ...
                        <div class="box-body">                        
                          ...
                          {!! Form::label('country','Pais',['class'=>'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                              {!! Form::text('country',null,['class'=>'form-control','placeholder'=>'Pais']) !!}
                            </div>
                          </div>
                          <div class="form-group">
                            {!! Form::label('iso','Iso',['class'=>'col-sm-2 control-label']) !!}

                            <div class="col-sm-10">
                              {!! Form::text('iso',null,['class'=>'form-control','placeholder'=>'Iso del pais']) !!}
                            </div>
                          </div>
                        </div>
